  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ width: '100%', maxWidth: 1200, mb: 3, display: 'flex', alignItems: 'center', justifyContent: 'space-between', mx: { xs: 2, sm: 'auto' } }}>
      ...
      <Box
        ...
        >
          ...
          {/* Features Section */}
          <Box sx={{ width: '100%', maxWidth: 1200, mt: 6, mx: { xs: 2, sm: 'auto' } }}>
            <Typography variant="h5" fontWeight={700} sx={{ color: '#222', mb: 3, textAlign: 'center' }}>
              Key Features
            </Typography>
